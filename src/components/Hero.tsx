...
const Hero = () => {
  return <section id="home" className="relative bg-gradient-warm overflow-hidden">
      ...
      {/* Main Hero Content */}
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-7xl mx-auto">
          ...
          <div className="lg:order-2 space-y-8 animate-fade-in">
            <div className="space-y-6">
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">Partner with Savory Synergy to keep receiving orders from DoorDash, GrubHub, your website & POS system the same way while using our driver network for delivery.</p>
            </div>
