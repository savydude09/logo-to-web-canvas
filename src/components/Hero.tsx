        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-7xl mx-auto">
          ...
          <div className="lg:order-2 space-y-8 animate-fade-in">
            <div className="space-y-6">
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">Partner with Savory Synergy to keep receiving orders from DoorDash or GrubHub the same way while using flexible delivery for fulfillment.</p>
            </div>
