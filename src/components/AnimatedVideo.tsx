...
const voiceOverScript = [{
  ...
  scene: 2,
  text: "Here's how seamless it is: Your customers still place orders through DoorDash or GrubHub for delivery. You receive and prepare the order exactly as you always do. And through flexible delivery we can still have DoorDash, GrubHub fulfill deliveries. The result? You keep more money in your pocket.",
  duration: 12000
}, {
  scene: 3,
